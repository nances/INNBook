 ...
 */
public class TopCategoryMaleListAdapter extends EasyRVAdapter<CategoryList.MaleBean> {
    private OnRvItemClickListener itemClickListener;

    public TopCategoryMaleListAdapter(Context context, List<CategoryList.MaleBean> list) {
...
//                SubCategoryListActivity.startActivity(mContext, item.getName(), Constant.Gender.MALE);
