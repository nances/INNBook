package com.kaqi.niuniu.ireader.widget.recyclerview;
...
import com.kaqi.niuniu.ireader.widget.recyclerview.decoration.DividerDecoration;
import com.kaqi.niuniu.ireader.widget.recyclerview.swipe.OnRefreshListener;
import com.kaqi.niuniu.ireader.widget.recyclerview.swipe.SwipeRefreshLayout;
...
public class EasyRecyclerView extends FrameLayout {
    ...
    public static class EasyDataObserver extends AdapterDataObserver {
        ...
        private void update() {
            ...
            if (count == 0 && !NetworkUtils.isAvailable()) {
