package com.kaqi.niuniu.ireader.service;
...
import com.kaqi.niuniu.ireader.ui.base.BaseService;
                ...
                .subscribe(
                        chapterInfo -> {
                            ...
                            BookRepository.getInstance()
                                    .saveChapterInfo(folderName, bean.getTitle(),chapterInfo.getCpContent());
                        },
                        e -> {
