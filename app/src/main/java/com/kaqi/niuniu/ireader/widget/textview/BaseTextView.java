...
public class BaseTextView extends LinearLayout {
    ...
    private AppCompatTextView initTextView(LayoutParams params, AppCompatTextView textView) {
...
//        textView.setGravity(Gravity.CENTER);
     ...
     * @return 返回
     */
    public AppCompatTextView getTextView(AppCompatTextView textView, LayoutParams layoutParams) {
        if (textView == null) {
