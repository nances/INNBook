...
public class BookListFragment extends BaseMVPFragment<BookListContract.Presenter>
    ...
    /***************************************/
    private RecommendBookSelfType mBookListType;
    private String mTag = "";
    private int mStart = 0;
    private int mLimit = 20;

    public static Fragment newInstance(RecommendBookSelfType bookListType){
    ...
    protected void initData(Bundle savedInstanceState) {
        ...
        if(savedInstanceState != null){
            mBookListType = (RecommendBookSelfType) savedInstanceState.getSerializable(EXTRA_BOOK_LIST_TYPE);
            mTag = savedInstanceState.getString(BUNDLE_BOOK_TAG);
        }
        else {
            mBookListType = (RecommendBookSelfType) getArguments().getSerializable(EXTRA_BOOK_LIST_TYPE);
        }
    }
