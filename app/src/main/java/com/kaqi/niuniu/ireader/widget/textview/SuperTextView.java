package com.kaqi.niuniu.ireader.widget.textview;
...
//        mRightBottomTextBold = typedArray.getBoolean(R.styleable.SuperTextView_sRightBottomTextIsBold, false);
    ...
    private void initLeftIcon() {
        ...
        leftImgParams = new LayoutParams(DisplayUtil.dp2px(mContext,22),DisplayUtil.dp2px(mContext,22));
    ...
    private void setDefaultColor(BaseTextView baseTextView, ColorStateList topTextColor, ColorStateList textColor, ColorStateList bottomTextColor) {
        if (baseTextView != null) {
            if (topTextColor == null) {
                topTextColor = ColorStateList.valueOf(getResources().getColor(R.color.common_h1));
            }
            if (textColor == null) {
                textColor = ColorStateList.valueOf(getResources().getColor(R.color.common_h1));
            }
            if (bottomTextColor == null) {
                bottomTextColor = ColorStateList.valueOf(getResources().getColor(R.color.common_h1));
            }
